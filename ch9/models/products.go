...
type Product struct {
	ProductNo int    `boil:"product_no" json:"product_no" toml:"product_no" yaml:"product_no"`
...
var ProductWhere = struct {
	ProductNo whereHelperint
	Name      whereHelperstring
	Price     whereHelperint
}{
	ProductNo: whereHelperint{field: "\"products\".\"product_no\""},
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, productNo int, selectCols ...string) (*Product, error) {
	productObj := &Product{}
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, productNo int) (bool, error) {
	var exists bool
